...
class BgPlayerPositionCacheService extends BaseCacheService
{
    public const NAME = BoardGamePlayerPosition::CACHE_NAME;
    public const MODEL = BoardGamePlayerPosition::class;
