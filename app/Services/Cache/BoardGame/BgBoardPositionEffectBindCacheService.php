...
class BgBoardPositionEffectBindCacheService extends BaseCacheService
{
    public const NAME = BoardPositionEffectsBind::CACHE_NAME;
    public const MODEL = BoardPositionEffectsBind::class;
