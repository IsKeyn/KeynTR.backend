...
class BgBoardPositionEffectCacheService extends BaseCacheService
{
    public const NAME = BoardPositionEffect::CACHE_NAME;
    public const MODEL = BoardPositionEffect::class;
