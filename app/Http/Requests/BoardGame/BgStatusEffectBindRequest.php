...
class BgStatusEffectBindRequest extends FormRequest
{
    ...
    {
        return [
            'status_effect_id' => 'required|integer|sometimes',
    ...
    {
        return [
            'status_effect_id.required' => 'status_effect_id обязательно для заполнения.',
