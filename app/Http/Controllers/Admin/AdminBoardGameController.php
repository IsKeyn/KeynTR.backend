...
class AdminBoardGameController extends Controller {
    ...
    {
        $model = 'App\Models\BoardGame\\' . $entityName;
...
//        return view('admin.entity.form', compact('data'));
    ...
    public function destroy($entityName, $id) {
        ...
        if (in_array('BoardGame', self::ENTITY_WITH_BINDS)) {
            $bindTableName = strtolower('BoardGame' . '_binds');
            $tableColumnName = strtolower('BoardGame' . '_id');
