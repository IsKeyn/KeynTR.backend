...
Route::prefix('BoardGame')->group(function () {
    ...
    Route::name('status-effect-bind')->middleware(['can:bg.status-effect-on-player.edit'])->group(base_path('routes/api/admin/fragments/BgFragments/StatusEffectBind.php'));
