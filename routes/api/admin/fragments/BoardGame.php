...
Route::prefix('BoardGame')->group(function () {
    ...
    Route::name('shop-item')->middleware(['can:bg.shop-item.edit'])->group(base_path('routes/api/admin/fragments/BgFragments/ShopItem.php'));
    ...
    Route::name('add-game')->middleware(['can:bg.add-game.edit'])->group(base_path('routes/api/admin/fragments/BgFragments/AddGame.php'));
